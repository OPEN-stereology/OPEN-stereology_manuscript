...
msg = sprintf([ ...
    'NOTICE: OPEN‑Stereology — Reviewer Build\n\n' ...
    'Two files are withheld from the public repo during peer review:\n' ...
    '  • open_stereo.m (final)\n' ...
    '  • open_stereo.fig (UI figure)\n\n' ...
    'If you are a reviewer:\n' ...
    '  1) Request the password and archive from the journal/authors.\n' ...
    '  2) Unzip the archive.\n' ...
    '  3) Replace src/open_stereo.m with the unzipped file.\n' ...
    '  4) Copy open_stereo.fig into src/ (next to open_stereo.m).\n\n' ...
    'All other components are available in this repository.\n' ...
    'This build is for evaluation only; redistribution or use beyond peer review is not permitted.\n\n' ...
